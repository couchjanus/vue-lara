 <section class="intro intro-h-600px">
            <section class="intro-row intro-h-2-3 mb-10x">
                <section class="intro-2-3-col intro-h-100 position-relative h-md-300px">
                    <a href="">
                        <section class="intro-2-3-item img-bg bg-1 intro-h-100"></section>
                        <section class="intro-item-caption">
                            <h3 class="caption-title">
                                <span>Peter Thiels VC Found Invests Million into Bitcoin, Market Reacts</span>
                            </h3>
                            <ul class="caption-info-bar">
                                <li class="">by <b class="text-yellow">Olivia Capzallo,</b> Jan 25, 2018</li>
                        ...
                        <a href="">
                            ...
                            <section class="intro-item-caption">
                                ...
                                <ul class="caption-info-bar">
                                    <li>Jan 25, 2018</li>
                                    <li><i class="fas fa-bolt text-yellow"></i> 30,190</li>
                                    <li><i class="fas fa-comments text-yellow"></i> 58</li>
                                </ul>
                            </section>
                        </a>
                        ...
                        <a href="">
                            ...
                            <section class="intro-item-caption">
                                ...
                                <ul class="caption-info-bar">
                                    <li>Jan 25, 2018</li>
                                    <li><i class="fas fa-bolt text-yellow"></i> 30,190</li>
                                    <li><i class="fas fa-comments text-yellow"></i> 31</li>
                                </ul>
                            </section>
                        </a>
                    </section>
                    ...
                    <a href="">
                        ...
                        <section class="intro-item-caption">
                            ...
                            <ul class="caption-info-bar">
                                <li>Jan 25, 2018</li>
                                <li><i class="fas fa-bolt text-yellow"></i> 30,190</li>
                                <li><i class="fas fa-comments text-yellow"></i> 95</li>
                            </ul>
                        </section>
                    </a>
                </section>
                    ...
                    <a href="">
                        ...
                        <section class="intro-item-caption">
                            ...
                            <ul class="caption-info-bar">
                                <li>Jan 25, 2018</li>
                                <li><i class="fas fa-bolt text-yellow"></i> 30,190</li>
                                <li><i class="fas fa-comments text-yellow"></i> 76</li>
                            </ul>
                        </section>
                    </a>
                </section>
                    ...
                    <a href="">
                        ...
                        <section class="intro-item-caption">
                            ...
                            <ul class="caption-info-bar">
                                <li>Jan 25, 2018</li>
                                <li><i class="fas fa-bolt text-yellow"></i> 30,190</li>
                                <li><i class="fas fa-comments text-yellow"></i> 28</li>
                            </ul>
                        </section>
                    </a>
                </section>
